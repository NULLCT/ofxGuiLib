...
void ofApp::btnsetup() {
  ...
  */
  ...
  btn[0][0].button_enablesimplebox = true;
  ...
  btn[1][2].button_word = u8"使\nう\nな";
  btn[1][2].button_enablesimplebox = true;
  ...
  btn[1][3].button_word = u8"使\nう\nな";
  btn[1][3].button_enablesimplebox = true;
