...
class buttondate {
 public:
  ...
  int button_underlinebeginx = 0, button_underlinebeginy = 0,
      button_underlinelenght = 0;
};
class ofApp : public ofBaseApp {
  ...
  */
  vector<string>
      screen2_isbndates;  // books list in screen2 has{string(isbn),int(sum)}
};
